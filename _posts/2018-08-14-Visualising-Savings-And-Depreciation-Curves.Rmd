...
comparison_plot_classic$subset <- factor(comparison_plot_classic$subset,
                                 levels = c('Developing',
                                            'Intermediate',
                                            'Rich',
                                            'Non-Oil MRW',
...
p <- plot_new_vs_old('alpha', comparison_plot_classic) %>%
...
q <- plot_new_vs_old('beta', comparison_plot_classic)
